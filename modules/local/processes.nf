...
process IDSTOSAMPLES { 
    ...
    script: 
    """
    csvjoin -t -c SAMPLE,platekey ${id_list} ${sample_list} | csvcut -c CHROM,POS,REF,ALT,GT,platekey,participant_id,type,study_source | csvgrep -c GT -m 0/0 -i > results.csv
    """
}
